...
typedef struct
{
	...
	// 2. Внутрішній стан
	uint64_t lastDebounceTime; // Час останньої зміни стану
	uint64_t pressStartTime;   // Час початку натискання кнопки
	uint64_t lastRepeatTime;   // Час останнього повтору довгого натискання
	...
	bool stateChanged;	  // Ознака зміни стану кнопки
